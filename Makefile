...
ACLOCAL = ${SHELL} /tmp/protobuf-2.6.1/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /tmp/protobuf-2.6.1/missing autoconf
AUTOHEADER = ${SHELL} /tmp/protobuf-2.6.1/missing autoheader
AUTOMAKE = ${SHELL} /tmp/protobuf-2.6.1/missing automake-1.14
AWK = mawk
CC = gcc
...
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} /tmp/protobuf-2.6.1/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 2.6.1
abs_builddir = /tmp/protobuf-2.6.1
abs_srcdir = /tmp/protobuf-2.6.1
abs_top_builddir = /tmp/protobuf-2.6.1
abs_top_srcdir = /tmp/protobuf-2.6.1
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /tmp/protobuf-2.6.1/install-sh
